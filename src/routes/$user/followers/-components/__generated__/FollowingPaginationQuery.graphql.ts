/**
 * @generated SignedSource<<07d08ae3a160113ae0f29fc97377d674>>
...
return {
  ...
  "params": {
    "cacheID": "5deb1310152adca646ca44560b7e25b6",
    "id": null,
    "metadata": {},
    "name": "FollowingPaginationQuery",
    "operationKind": "query",
    "text": "query FollowingPaginationQuery(\n  $after: String\n  $first: Int = 10\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...UserFollowersFragment_following_2HEEH6\n    id\n  }\n}\n\nfragment UserFollowersFragment_following_2HEEH6 on User {\n  following(first: $first, after: $after) {\n    edges {\n      node {\n        ...UserFragmentCard_user\n        id\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n      hasPreviousPage\n      startCursor\n    }\n    totalCount\n  }\n  id\n}\n\nfragment UserFragmentCard_user on User {\n  id\n  name\n  login\n  email\n  bio\n  avatarUrl\n  company\n  twitterUsername\n  createdAt\n  isFollowingViewer\n  viewerIsFollowing\n  isViewer\n  location\n  url\n}\n"
  }
};
})();

(node as any).hash = "afb66cb3c597e927cff6bf176eb87f3f";
