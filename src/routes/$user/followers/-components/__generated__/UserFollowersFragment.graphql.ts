/**
 * @generated SignedSource<<973dcea18eeb59b0d8d487aaa51e73e2>>
...
export type UserFollowersFragment$data = {
  ...
  readonly id: string;
  readonly " $fragmentType": "UserFollowersFragment";
};
export type UserFollowersFragment$key = {
  readonly " $data"?: UserFollowersFragment$data;
...
(node as any).hash = "703ac651ac8d382461a79181e4c5a7c3";
