/**
 * @generated SignedSource<<26580ae10a1f5cef2face41133431bc2>>
...
export type ReposPageQuery$variables = {
  isFork?: boolean | null | undefined;
  login: string;
  orderBy?: RepositoryOrder | null | undefined;
};
export type ReposPageQuery$data = {
  readonly user: {
    readonly " $fragmentSpreads": FragmentRefs<"Repos_repositories">;
  } | null | undefined;
};
export type ReposPageQuery = {
  response: ReposPageQuery$data;
  variables: ReposPageQuery$variables;
};
