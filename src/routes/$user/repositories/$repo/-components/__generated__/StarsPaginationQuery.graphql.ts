...
export type StarsPaginationQuery$variables = {
  after?: string | null | undefined;
  first?: number | null | undefined;
  id: string;
};
export type StarsPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"Stars_stargazers">;
  } | null | undefined;
};
export type StarsPaginationQuery = {
  response: StarsPaginationQuery$data;
  variables: StarsPaginationQuery$variables;
};
