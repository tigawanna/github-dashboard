...
export type UserReposPageQuery$variables = {
  isFork?: boolean | null | undefined;
  login: string;
  orderBy?: RepositoryOrder | null | undefined;
};
export type UserReposPageQuery$data = {
  readonly user: {
    readonly " $fragmentSpreads": FragmentRefs<"UserRepos_repositories">;
  } | null | undefined;
};
export type UserReposPageQuery = {
  response: UserReposPageQuery$data;
  variables: UserReposPageQuery$variables;
};
...
(node as any).hash = "ddae72e553bf60bfda3648b3494fb7e3";
