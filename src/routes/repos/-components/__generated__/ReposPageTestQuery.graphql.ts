/**
 * @generated SignedSource<<969087b22e8d2a4d0b845d30e21753a1>>
...
export type ReposPageTestQuery$variables = {
  isFork?: boolean | null | undefined;
  login: string;
  orderBy?: RepositoryOrder | null | undefined;
};
export type ReposPageTestQuery$data = {
  readonly user: {
    readonly " $fragmentSpreads": FragmentRefs<"Repos_repositories">;
  } | null | undefined;
};
export type ReposPageTestQuery = {
  response: ReposPageTestQuery$data;
  variables: ReposPageTestQuery$variables;
};
