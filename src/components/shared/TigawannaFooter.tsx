...
export function TigawannaFooter({}: TigawannaFooterProps) {
  return (
    <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10">
      ...
      <div className="w-full flex items-end justify-center h-full ">
        ...
        <a target="_blank" className="flex gap-1 btn btn-link" href="https://github.com/tigawanna">
          <svg
            width="20px"
            height="20px"
            viewBox="0 0 20 20"
        ...
        <a target="_blank" className="flex gap-1 btn btn-link" href={projectGithubUrl}>
          project repository
        </a>
      </div>
      <div className="w-full flex items-end h-full"></div>
    </footer>
  );
}
